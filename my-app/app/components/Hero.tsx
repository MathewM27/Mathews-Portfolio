        ...
        <div className="max-w-7xl lg:max-w-[1400px] mx-auto w-full relative z-10 flex flex-col md:flex-row gap-2 sm:gap-3 lg:gap-4">
          ...
          >
            {[
              ...
              { href: "https://wa.me/23059300798", label: "WhatsApp", icon: <MessageCircle className="w-4 h-4" /> },
              { href: "mailto:mathewsmwangi6927@gmail.com", label: "Email", icon: <Mail className="w-4 h-4" /> },
            ].map(({ href, label, icon }) => (
