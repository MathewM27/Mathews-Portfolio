      ...
      <div className="relative w-full flex justify-center items-center min-h-[180px]">
        <div className="flex gap-6 w-full justify-center">
          {getVisibleProjects().map((project, i) => (
            ...
            >
              <div
                className="w-24 h-24 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center mb-2"
              ...
              <a
                ...
                className="text-sm font-bold text-orange-500 hover:underline text-center truncate w-full"
                title={project.name}
...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full relative z-10 flex gap-6">
        {/* Main Content - 2 columns */}
        <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-fr">
          {/* Main Intro Section - spans full width on mobile, 2 cols x 2 rows on desktop */}
          <motion.div
            className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg md:col-span-2 md:row-span-2 relative overflow-hidden flex flex-col"
          ...
          >
            {/* Animated Blobs */}
            <span className="absolute top-4 left-4 w-32 h-32 bg-orange-500 opacity-30 rounded-full blur-2xl animate-pulse z-0"></span>
            <span className="absolute bottom-10 right-10 w-24 h-24 bg-black opacity-20 rounded-full blur-xl animate-ping z-0"></span>
            <span className="absolute top-1/2 left-1/2 w-16 h-16 bg-orange-400 opacity-20 rounded-full blur-lg animate-bounce z-0"></span>
            {/* Text Content */}
            <div className="flex flex-col flex-1 justify-center items-center text-center relative z-10 w-full h-full">
              ...
              <h1 className="mb-4 leading-tight">
                <span className="block text-6xl font-bold">Hi there!<span className="block">im</span></span>
                <span className="block text-orange-500 text-8xl font-extrabold">Mathews</span>
              </h1>
              <p className="text-black mb-8 font-semibold text-lg md:text-lg max-w-2xl">
                Founder of FutureX Designs ~ Entrepreneur and ~ Developer.
              </p>
            </div>
            <motion.button
              onClick={scrollToProjects}
              className="bg-orange-500 text-white px-8 py-3 rounded-xl  font-semibold shadow-lg hover:bg-orange-600 transition-colors w-full mt-auto relative z-10"
              whileHover={{ y: -3 }}
          ...
          {/* Skills Section */}
          <motion.div
            className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg md:col-span-2 relative flex flex-col"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.1 }}
            viewport={{ once: true }}
          >
            <p className="text-lg font-medium text-black mb-8 text-center">
...
{/* Experience Section */}
          <motion.div
            className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg flex flex-col justify-center"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="ml-4 flex-1 border-t border-gray-200 mx-4"></span>
        ...
        {/* Social Media Column - Narrow width, full height */}
        <motion.div
          className="hidden md:flex flex-col bg-white border border-gray-200 rounded-2xl p-4 shadow-lg w-16 justify-center gap-6"
